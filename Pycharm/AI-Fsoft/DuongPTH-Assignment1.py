# -*- coding: utf-8 -*-
"""DuongPTH-Assignment1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JSYSTgHu-VQvfhSbYVYPkhoiN9FXhek6
...
def display_cover(top, bottom):
    ...
    # %ls /usr/share/fonts/truetype/ -t -U
    ...
    band_name_font = ImageFont.truetype("/usr/share/fonts/truetype/liberation/LiberationMono-Bold.ttf", 25)  # 25pt font
    album_name_font = ImageFont.truetype("/usr/share/fonts/truetype/liberation/LiberationMono-Bold.ttf",
                                         20)  # 20pt font
...
img2 = display_cover('Python', 'Data Science')

img2.save('sample-out.png')
IPythonImage(filename='sample-out.png')
...
title = page[page.find('<title>', 0, len(page)) + 7:page.find('</title>', 0, len(page))]
